...
% %--------------------------------------------------------------------------
NameFileMeshDATA = 'Malla20' ;   %  This is the name of GIDs project
...
NEUMANN(icond).FORCE_PER_UNIT_SURFACE= [0,-0.5,0] ;% the units of the  Young's Modulus, and the units of length employed in GID). In this case, 500 KN/m2
% = 0.5 MPa
